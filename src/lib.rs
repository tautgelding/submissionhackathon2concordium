...
#[init(contract = "submissionhackathon2concordium")]
...
#[receive(
    contract = "submissionhackathon2concordium",
    name = "receive",
    parameter = "bool",
    error = "Error",
    mutable
...
#[receive(contract = "submissionhackathon2concordium", name = "view", return_value = "State")]
